...
public class JFontChooser extends JComponent
{
	...
	private static final Font DEFAULT_SELECTED_FONT = new Font(Font.SERIF, Font.PLAIN, 12);
	...
	public void setSelectedFontFamily(String name)
	{
		if (name == null)
		{
			throw new IllegalArgumentException("'selectedFontFamily' is not allowed null.");
		}

		String oldName = getSelectedFontFamily();
